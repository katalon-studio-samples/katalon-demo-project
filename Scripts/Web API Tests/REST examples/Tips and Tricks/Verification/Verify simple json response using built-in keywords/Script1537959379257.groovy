...
ResponseObject response = WS.sendRequest(findTestObject('Web API Tests/REST examples/Tips and Tricks/Verification/Verify simple response using built-in keywords', [('authorization') : GlobalVariable.authorization
            , ('issue_key') : 'KD-1']))
