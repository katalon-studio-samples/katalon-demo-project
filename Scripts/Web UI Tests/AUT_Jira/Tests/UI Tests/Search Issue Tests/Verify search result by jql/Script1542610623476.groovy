...
println CustomKeywords.'com.jira.components.IssueSearchResult.getIssues'(findTestObject('Web UI Tests/AUT_Jira/Test Objects/Pages/Search Issue Page/Search Issue Result/elResultTable'))
